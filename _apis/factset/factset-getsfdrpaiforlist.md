---
aid: factset:factset-getsfdrpaiforlist
name: Gets Principle Adverse Impact (PAI) data to support compliant SFDR Sustainable Finance Disclosure Regulation (SFDR) reporting
tags:
- Factset
humanURL: 
properties: []
