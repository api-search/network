...
properties:
  - url: https://developer.factset.com/api-catalog/portfolio-metadata-api#overview
    type: Documentation
  - url: >-
      https://developer.factset.com/api-catalog/portfolio-metadata-api#sdkLibrary
    type: SDKs
  - url: https://developer.factset.com/api-catalog/portfolio-metadata-api#notebooks
    type: Jupyter Notebooks
  - url: >-
      https://developer.factset.com/api-catalog/portfolio-metadata-api#codeSnippet
    type: Code Snippets
  - url: https://developer.factset.com/api-catalog/portfolio-metadata-api#changelog
    type: Change Log
  - url: properties/portfolio-metadata-openapi-original.yml
    type: OpenAPI
description: >-
  The Portfolio Metadata API will allow users to read, write, and edit ACCTs and
  ACCT properties as well as ACTMs and components.
