...
properties:
  ...
  - url: >-
    ...
    type: Change Log
  - url: properties/direct-streaming-of-transaction-messages-openapi-original.yml
    type: OpenAPI
description: >-
  Connect transaction data from your OMS to be leveraged in FactSet's PMP and
