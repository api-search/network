...
humanURL: https://developer.factset.com/api-catalog/documents-distributor-documents-api
overlays:
...
properties:
  ...
  - url: properties/documents-distributor-documents-openapi-original.yml
    type: OpenAPI
description: >-
  Documents APIs that provide filings such as Global Filings and XML files such
  as StreetAccount
