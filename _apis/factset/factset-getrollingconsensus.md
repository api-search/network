---
aid: factset:factset-getrollingconsensus
name: Retrieves consensus estimates for a requested list of ids and rolling fiscal periods.
tags:
- Factset
- Estimates
- Rolling
