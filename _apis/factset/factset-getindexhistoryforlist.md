---
aid: factset:factset-getindexhistoryforlist
name: Retrieves Index Level Prices and Returns information for a list of identifiers and historical date range.
tags:
- Factset
- Benchmarks
- Index
