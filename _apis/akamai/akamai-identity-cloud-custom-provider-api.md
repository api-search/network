...
description: >-
  ...
  such as Facebook or Twitter. For example, instead of logging on by using an
  email address and password users can log on by using their Facebook account or
