...
properties:
  - url: https://docs.klarna.com/api/hpp-merchant/
    ...
    description: >-
      ...
      side of Klarna Payments. A complete HPP payment session will involve three
      of Klarna services.
  - url: properties/hosted-payment-page-api-openapi.yml
    type: OpenAPI
description: >-
  Hosted Payment Page (HPP) API is a service that lets you integrate Klarna
  Payments without the need of hosting the web page that manages the client side
  of Klarna Payments.
