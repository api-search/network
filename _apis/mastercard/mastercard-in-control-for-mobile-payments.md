...
properties:
  - url: >-
    ...
    name: API Basics | In Control for Mobile Payments | Mastercard Developers
    type: Security
  - url: >-
  ...
  - url: >-
    ...
    name: Use Cases | In Control for Mobile Payments | Mastercard Developers
    type: UseCases
  - url: >-
      https://developer.mastercard.com/in-control-for-mobile-payments/documentation/api-reference/
    name: API Reference | In Control for Mobile Payments | Mastercard Developers
    type: Documentation
  - url: >-
      https://developer.mastercard.com/in-control-for-mobile-payments/documentation/tutorials-and-guides/
    name: >-
      Tutorials and Guides | In Control for Mobile Payments | Mastercard
      Developers
    type: Tutorials
  - url: >-
      https://developer.mastercard.com/in-control-for-mobile-payments/documentation/testing/
    name: Testing | In Control for Mobile Payments | Mastercard Developers
    type: Testing
  - url: >-
      https://developer.mastercard.com/in-control-for-mobile-payments/documentation/code-and-formats/
    name: Code and Formats | In Control for Mobile Payments | Mastercard Developers
    type: Errors
  - url: >-
      https://developer.mastercard.com/in-control-for-mobile-payments/documentation/reference-app/
    name: Reference App | In Control for Mobile Payments | Mastercard Developers
  ...
  - url: >-
    ...
    name: Support | In Control for Mobile Payments | Mastercard Developers
    type: FAQ
  - url: >-
...
description: >-
  ...
  addition to e-commerce purchasing, users can utilize tap-and-go (contactless)
  purchasing and enjoy a faster checkout experience.
