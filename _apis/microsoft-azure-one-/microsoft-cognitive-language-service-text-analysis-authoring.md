...
properties:
  - url: https://example.com
    type: Documentation
  - url: >-
      properties/microsoft-cognitive-language-service-text-analysis-authoring-openapi-original.yml
    type: OpenAPI
description: >-
  ...
  can be used to analyze unstructured text for tasks such as sentiment analysis,
  key phrase extraction, language detection and question answering. Further
