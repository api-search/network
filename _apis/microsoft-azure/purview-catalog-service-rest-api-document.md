...
properties:
  - url: https://example.com
    type: Documentation
  - url: properties/purview-catalog-service-rest-api-document-openapi-original.yml
    type: OpenAPI
description: >-
  ...
  At the same time, Data Catalog helps organizations get more value from their
  existing investments. This spec defines REST API of Purview Catalog Service.
