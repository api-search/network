...
properties:
  ...
  - url: >-
    ...
    type: Examples
  - url: https://docs.aws.amazon.com/audit-manager/latest/userguide/dashboard.html
    type: Dashboard
description: >-
  ...
  ongoing auditing of your Amazon Web Services usage. With this tool, users can
  evaluate the effectiveness of controls, mitigate risks, and simplify
