...
properties:
  ...
  - url: https://aws.amazon.com/dynamodbaccelerator/customers/
    type: Customers
description: >-
  DAX is a managed caching service designed specifically for Amazon DynamoDB. It
  significantly boosts database read speeds by storing frequently accessed data
  from DynamoDB, allowing applications to retrieve that data with extremely low
  latency. Setting up a DAX cluster is a straightforward process through the AWS
  Management Console. 
