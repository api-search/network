...
properties:
  - url: https://aws.amazon.com/aws-cost-management/aws-application-cost-profiler/
    type: Documentation
  - url: properties/applicationcostprofiler-openapi-original.yml
    type: OpenAPI
description: >-
  The AWS Application Cost Profiler API enables users to manage application cost
  report definitions, including viewing, creating, updating, and deleting them.
  It also allows users to import usage data into the Application Cost Profiler
  service. For more information on using this API, please consult the AWS
