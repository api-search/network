...
properties:
  ...
  - url: properties/resource-groups-openapi-original.yml
    type: OpenAPI
description: >-
  The Resource Groups API allows users to effectively organize various Amazon
  Web Services resources, including instances from Amazon Elastic Compute Cloud,
  databases from Amazon Relational Database Service, and buckets from Amazon
