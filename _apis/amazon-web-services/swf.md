...
description: >-
  ...
  distributed components. Tasks in Amazon SWF represent individual units of work
  within a workflow, with the service handling the management of intertask
  dependencies, scheduling, and concurrency to maintain the logical flow of the
  application.
