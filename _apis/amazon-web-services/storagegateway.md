...
properties:
  ...
  - url: https://aws.amazon.com/storagegateway/features/
    type: Features
description: >-
  The Storage Gateway Service API allows seamless and secure integration between
  on-premises software appliances and cloud-based storage within Amazon Web
  Services infrastructure. This service enables cost-effective backup and rapid
  disaster recovery by allowing secure data uploads to the AWS cloud. 
