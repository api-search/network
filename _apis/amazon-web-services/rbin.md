...
properties:
  - url: https://docs.aws.amazon.com/recyclebin/latest/APIReference/Welcome.html
    type: Documentation
...
description: >-
  ...
  recover accidentally deleted snapshots and EBS-backed AMIs. The documentation
  provides detailed descriptions and syntax for each action and data type within
  Recycle Bin. When you use Recycle Bin, any deleted resources are stored in the
  bin for a specified time period. 
