...
description: >-
  ...
  various aspects of database load by capturing data from a running DB instance.
  This guide provides detailed information on Performance Insights data types,
  parameters, and errors. With Performance Insights enabled, the API offers
  visibility into the performance of your DB instance. Amazon CloudWatch serves
  as the source for monitoring metrics, while Performance Insights provides a
  specialized view of DB load, measured in average active sessions. 
