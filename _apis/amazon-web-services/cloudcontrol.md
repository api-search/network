...
description: >-
  ...
  services by providing a standardized set of APIs for developers and partners.
  With five key operations (CRUDL), users can easily create, read, update,
  delete, and list their cloud infrastructure.
