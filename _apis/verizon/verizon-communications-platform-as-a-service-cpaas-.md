...
description: >-
  ...
  Communications Platform as a Service (CPaaS) offering provides a set of APIs
  that you can leverage to build customized solutions for inbound and outbound
  IP interactive voice response (IPIVR) and call detail reporting.
